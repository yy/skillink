...
HTML_MARKER = '<meta name="generator" content="skillink">'
...
def write_html(output: Path, content: str) -> None:
    ...
    if output.exists():
        require(
            ...
            f"refusing to overwrite a file not generated by Skillink: {output}",
        )
    output.parent.mkdir(parents=True, exist_ok=True)
    # NamedTemporaryFile creates mode 0600, including when replacing an older catalog.
    temporary = None
    try:
...
def main() -> int:
    ...
    try:
        ...
        if args.html or args.open:
            ...
            write_html(output, html_catalog(rows, manifest))
